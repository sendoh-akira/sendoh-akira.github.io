! function(e, t, s) {
    ...
    if (o.extend = function(e, t) {
        ...
        for (var L = 0, I = ["EmbedThread", "RecentComments", "RecentVisitors", "TopUsers", "TopThreads", "LoginWidget", "ThreadCount"]; L < I.length; L++) S[I[L]] = function(e) {
            return function(t, s) {
                s = s || {}, s.type = e, t && !O[t] && (O[t] = s), S.initSelector && S.initSelector(t, s)
            }
        }(I[L]), S["create" + I[L]] = function(e) {
            return function(s, a) {
        ...
        S.DOMAIN = "duoshuo.com", S.STATIC_URL = g + "//static.duoshuo.com", S.REMOTE = g + "//duoshuo.com", S.version = "15.9.25";
        var U = {
                "default": "080f31b2",
                dark: "ddc346d8",
                bluebox: "0f0f035c",
            ...
            W = S.loadRequire = function(e) {
                if (e.visitor && (!nt.data && e.visitor.user_id && Notification && !Notification.requestPermission() && A.send({
                    ...
                    }), nt.reset(e.visitor)), e.site && (rt.reset(e.site), D.save("ds_site_" + c.short_name, e.site)), !S.theme && rt.data.theme && n(rt.data.theme), e.lang && (o.extend(z, e.lang), D.save("ds_lang_" + c.short_name, e.lang)), e.stylesheets)
                    for (var t = 0; t < e.stylesheets.length; t++) o.injectStylesheet(e.stylesheets[t]);
                if (e.nonce && (S.nonce = e.nonce), e.style && o.injectStyle((e.style || "") + S.compileStyle(c.component_style)), e.unread && ot.reset(e.unread), e.warnings)
                    for (var t = 0; t < e.warnings.length; t++) C.warn(e.warnings[t])
            },
            H = 0,
            B = S.Class = function() {};
        B.extend = function(e) {
        ...
        it.on("queryDefined", function() {
            ...
            function T(e) {
                ...
                B("#ds-notify").hide(), M.get(t.apiUrl, {}, function(e) {
            ...
            e.postMessage && (e.addEventListener ? e.addEventListener("message", g, !1) : e.attachEvent && e.attachEvent("onmessage", g)), S.scrollTo = function(e) {
                ...
                reset: function(e) {
                    ...
                    var a = "<ul>";
                    return B.each(N[e], t), a += "</ul>", this.el.find(".ds-smilies-container").html(a), this
                }
            ...
            var X = B('<div id="ds-bubble"><div class="ds-bubble-content"></div><div class="ds-arrow ds-arrow-down ds-arrow-border"></div><div class="ds-arrow ds-arrow-down"></div></div>'),
                K = X.find(".ds-bubble-content").delegate("a.ds-ctx-open", "click", function() {
                    ...
                    var t = {};
                    t.post_id = K.attr("data-post-id"), M.get("posts/conversation", t, e);
                ...
                tt = bubbleOutTimer = 0;
            X.mouseenter(L).mouseleave(I), st.PostList = function(e) {
                ...
                refetch: function() {
                    ...
                    s.el.fadeTo(200, .5), M.get(s.url, s.params, e)
                }
                ...
                render: function() {
                    var e = this.el;
                    e.attr("id", "ds-login").html(et.loginWidget(["weibo", "qq", "renren", "kaixin", "douban", "netease", "sohu"])), e.find("a").click(l), e.find("a.ds-logout").attr("href", Z.logoutUrl())
                }
            ...
            S.initSelector = function(e, t) {
                ...
                }, 2e4), c.ondomready && c.ondomready(), S.initView(), !it && c.short_name && M.get("analytics/ping", H({}), W)
            })
        })
    }
}(window, document);
