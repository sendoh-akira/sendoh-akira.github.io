...
function() {
    return function(e) {
        ...
        n = function() {
            function e(a) {
                function t(e) {
                    for (var a = e.offsetLeft,
                    t = e.offsetParent,
                    l = void 0; null !== t;) a += t.offsetLeft,
                    t = t.offsetParent;
                    return l = document.body.scrollLeft + document.documentElement.scrollLeft,
                    a - l
                }
                function r(e) {
                    for (var a = e.offsetTop,
                    t = e.offsetParent,
                    l = void 0; null !== t;) a += t.offsetTop,
                    t = t.offsetParent;
                ...
                for (var p in s) s.hasOwnProperty(p) && !a.hasOwnProperty(p) && (a[p] = s[p]);
                if (this.playIndex = "[object Array]" === Object.prototype.toString.call(a.music) ? 0 : -1, this.option = a, this.audios = [], this.mode = a.mode, this.secondToTime = function(e) {
                    var a = function(e) {
                        return e < 10 ? "0" + e: "" + e
                    },
                    t = parseInt(e / 60),
                ...
                m.barWrap.style.marginLeft = this.element.getElementsByClassName("aplayer-time")[0].offsetWidth + 5 + "px",
                ...
                function() {
                    for (var e = n.element.getElementsByClassName("aplayer-list")[0].getElementsByTagName("li"), a = function(a) {
                        e[a].addEventListener("click",
                        function() {
                            var t = parseInt(e[a].getElementsByClassName("aplayer-list-index")[0].innerHTML) - 1;
                            t !== n.playIndex ? (n.setMusic(t), n.isMobile ? n.pause() : n.play()) : n.toggle()
                        })
                    },
                ...
                v = void 0;
                m.barWrap.addEventListener("click",
                function(e) {
                ...
                function() {
                    "random" === n.mode ? n.mode = "single": "single" === n.mode ? n.mode = "order": "order" === n.mode ? n.mode = "circulation": "circulation" === n.mode && (n.mode = "random"),
                    A.innerHTML = n.getSVG(n.mode),
                    n.audio.loop = !(n.multiple || "order" === n.mode)
                }), this.multiple && !
                function() {
                    var e = n.element.getElementsByClassName("aplayer-list")[0];
                    e.style.height = e.offsetHeight + "px",
                    n.element.getElementsByClassName("aplayer-icon-menu")[0].addEventListener("click",
                    function() {
                        e.classList.contains("aplayer-list-hide") ? e.classList.remove("aplayer-list-hide") : e.classList.add("aplayer-list-hide")
                    })
                } (), "random" === this.mode) {
                    var E = parseInt(Math.random() * this.option.music.length);
                    this.setMusic(E)
            ...
            return r(e, [{
                ...
                value: function(e) {
                    ...
                    this.multiple && (this.element.getElementsByClassName("aplayer-list-light")[0] && this.element.getElementsByClassName("aplayer-list-light")[0].classList.remove("aplayer-list-light"), this.element.getElementsByClassName("aplayer-list")[0].getElementsByTagName("li")[t].classList.add("aplayer-list-light")),
                    this.audio && (this.pause(), this.audio.currentTime = 0),
                    this.multiple && (this.element.getElementsByClassName("aplayer-list")[0].scrollTop = 33 * t),
                    this.multiple && !this.audios[t] || this.playIndex === -1 ? (this.audio = document.createElement("audio"), this.audio.src = this.music.url, this.option.preload ? this.audio.preload = this.option.preload: this.audio.preload = this.isMobile ? "none": "metadata", this.audio.addEventListener("durationchange",
                    function() {
                    ...
                    function() {
						...
						//try{this.pause()}catch(e){alert(e)};						
                    ...
                    function() {
                        a.trigger("canplay")
                    }), this.ended = !1, this.multiple ? this.audio.addEventListener("ended",
                    function() {
                        if (a.isMobile) return a.ended = !0,
                        void a.pause();
                        if (0 !== a.audio.currentTime) if ("random" === a.mode) {
                            var e = parseInt(Math.random() * a.option.music.length);
                            e === a.playIndex && (e++, e %= a.option.music.length),
                            a.setMusic(e)
                        } else "single" === a.mode ? a.setMusic(a.playIndex) : "order" === a.mode ? a.playIndex < a.option.music.length - 1 ? a.setMusic(++a.playIndex) : (a.ended = !0, a.pause(), a.trigger("ended")) : "circulation" === a.mode && (a.playIndex < a.option.music.length - 1 ? a.setMusic(++a.playIndex) : a.setMusic(0))
                    }) : this.audio.addEventListener("ended",
                    function() {
                        "order" === a.mode && (a.ended = !0, a.pause(), a.trigger("ended"))
                    ...
                    function() {
                        ...
                        function() {
                            var t = "";
                            1 === a.option.showlrc ? t = a.multiple ? a.option.music[e].lrc: a.option.music.lrc: 2 === a.option.showlrc || a.option.showlrc === !0 ? t = a.savelrc[e] : 3 === a.option.showlrc && !
                            function() {
                                ...
                                r.onreadystatechange = function() {
                                    if (4 === r.readyState) if (r.status >= 200 && r.status < 300 || 304 === r.status) {
                                        ...
                                        for (var n = 0; n < a.lrc.length; n++) i += "<p>" + a.lrc[n][1] + "</p>";
                                    ...
                                    } else console.log("Request was unsuccessful: " + r.status)
                                };
                                var i = void 0;
                        ...
                        var r = "";
                        a.lrcContents = a.element.getElementsByClassName("aplayer-lrc-contents")[0];
                        for (var i = 0; i < a.lrc.length; i++) r += "<p>" + a.lrc[i][1] + "</p>";
            ...
            },
            {
                ...
                value: function(e) {
                    ...
                    if ("[object Number]" === Object.prototype.toString.call(e) && (this.audio.currentTime = e), this.audio.paused) {
                        ...
                        100), this.option.mutex) for (var t = 0; t < i.length; t++) this != i[t] && i[t].pause();
                        this.audio.play().catch(error =>{this.audio.load();}),
    ...
    function(e, a, t) {
        function l(e, a) {
            for (var t = 0; t < e.length; t++) {
                ...
                if (r) {
                    ...
                    for (var n = [], i = 0; i < l.parts.length; i++) n.push(p(l.parts[i], a));
                    y[l.id] = {
                        id: l.id,
                        refs: 1,
                        parts: n
        ...
        function i(e, a) {
            var t = f(),
            l = b[b.length - 1];
            if ("top" === e.insertAt) l ? l.nextSibling ? t.insertBefore(a, l.nextSibling) : t.appendChild(a) : t.insertBefore(a, t.firstChild),
            b.push(a);
            else {
        ...
        function p(e, a) {
            ...
            if (a.singleton) {
                ...
                l = c.bind(null, t, i, !1),
                r = c.bind(null, t, i, !0)
            } else e.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (t = s(a), l = d.bind(null, t), r = function() {
                n(t),
                t.href && URL.revokeObjectURL(t.href)
            }) : (t = o(a), l = u.bind(null, t), r = function() {
                n(t)
            });
            return l(e),
            function(a) {
